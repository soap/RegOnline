 ...
 * @since       1.0
 */
class RegonlineModelSchedule extends JModelAdmin
{
	/**
	 * Method to get the Schedule form.
	 *
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Schedule', $prefix = 'RegonlineTable', $config = array())
	{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id)) {
			...
			if (empty($table->ordering)) {
				...
				$query->from('#__regonline_schedules');
				$query->where('course_id = '.(int) $table->course_id);
