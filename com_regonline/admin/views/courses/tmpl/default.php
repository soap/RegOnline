...
?>
<form action="<?php echo JRoute::_('index.php?option=com_regonline&view=courses');?>" method="post" name="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search"
				...
				title="<?php echo JText::_('COM_REGONLINE_COURSES_FILTER_SEARCH_DESC'); ?>" />
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_category_id" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_regonline'),
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canCreate	= $user->authorise('core.create',		'com_regonline.category.'.$item->category_id);
			$canEdit	= $user->authorise('core.edit',			'com_regonline.course.'.$item->id);
			$canCheckin	= $user->authorise('core.manage',		'com_checkin') || $item->checked_out == $user->get('id') || $item->checked_out == 0;
			$canChange	= $user->authorise('core.edit.state',	'com_regonline.course.'.$item->id) && $canCheckin;
			?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<a href="<?php echo JRoute::_('index.php?option=com_regonline&task=course.edit&id='.$item->id);?>">
