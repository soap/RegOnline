 ...
 * @since       1.0
 */
class RegonlineViewCourse extends JViewLegacy
{
	/**
	...
	/**
	 * Prepare and display the Course view.
	 *
	 * @return  void
	 * @since   1.0
	 */
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(
			JText::_(
				...
				($checkedOut
					? 'VIEW_COURSE'
					: ($isNew ? 'ADD_COURSE' : 'EDIT_COURSE')).'_TITLE'
			)
		);
		...
		if (!$checkedOut && $canDo->get('core.edit')) {
			...
			JToolBarHelper::custom('course.save2new', 'save-new.png', null, 'JTOOLBAR_SAVE_AND_NEW', false);
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('course.save2copy', 'save-copy.png', null, 'JTOOLBAR_SAVE_AS_COPY', false);
		}
