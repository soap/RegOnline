	...
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search"
				...
				title="<?php echo JText::_('COM_REGONLINE_SCHEDULES_FILTER_SEARCH_DESC'); ?>" />
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_course_id" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_REGONLINE_OPTION_SELECT_COURSE');?></option>
				<?php echo JHtml::_('select.options', JHtml::_('regonline.courseOptions'),
					'value', 'text', $this->state->get('filter.course_id'));?>
			</select>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_REGONLINE_HEADING_COURSE_TITLE', 'course_title', $listDirn, $listOrder); ?>
				</th>				
				<th width="5%">
				...
				<th width="10%" class="nowrap">
					...
					<?php echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'schedules.saveorder'); ?>
				</th>
				<th width="10%">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<a href="<?php echo JRoute::_('index.php?option=com_regonline&task=schedule.edit&id='.$item->id);?>">
				...
				<td class="order">
					<?php if ($canChange) : ?>
						<span><?php echo $this->pagination->orderUpIcon($i,
							true,
							'schedules.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
						<span><?php echo $this->pagination->orderDownIcon($i,
							$this->pagination->total,
							true,
							'schedules.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
